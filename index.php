	         ...
	         <ul> 
			   <li>
				  	<div class="suceess_story-date">
						<span class="entry-1">Dec 10, 2018</span>
					</div>
					<div class="suceess_story-content-container">
						...
						<div class="suceess_story-content-info">
				        	<h4><a href="#">Sara & Arif </a></h4>				        	
				        	<p> They are very happy couple. They are pleased with our service.<a href="#">More...</a></p>
				        </div>
				    </div>
				</li>
	            <li>
					...
					<div class="suceess_story-content-container">
						...
						<div class="suceess_story-content-info">
				        	<h4><a href="#">MR and Mrs Sha Rukh Khan</a></h4>				        	
				        	<p>They are our senior customer. They took our service and lead e happy life for 25 long years,.<a href="#">More...</a></p>
				        </div>
				    </div>
				</li>
		...
		<div class="container"> 
            ...
            <div class="col-sm-6">
            	<div class="bg_left">
            		...
            		<p>""I had a fantastic experience with Shaadi.com ! The user interface is very easy to navigate, and I felt secure and comfortable using the platform. I found genuine profiles and met amazing people. The detailed matching algorithms helped me find someone compatible, and I’m thrilled to say that I found my partner here! Highly recommend it to anyone serious about finding a meaningful connection.".</p>
            ...
            <div class="col-sm-6">
            	<div class="bg_left">
            		...
            		<p>"Shaadi.com has truly exceeded my expectations! The profile verification process gave me peace of mind, knowing I was connecting with genuine people. I loved the personalized match suggestions, which made it easy to find someone who shares my values and interests. The customer support was also super helpful whenever I had questions. Thanks to this platform, I’ve met my perfect match!.</p>
            	   <ul class="team-socials">
                    <li><a href="#"><span class="icon-social "><i class="fa fa-facebook"></i></span></a></li>
                    <li><a href="#"><span class="icon-social "><i class="fa fa-twitter"></i></span></a></li>
                    <li><a href="#"><span class="icon-social"><i class="fa fa-google-plus"></i></span></a></li>
